...
import cn.edu.gdou.jakec.campusbooking.MainActivity
...
class ForegroundOnlyLocationService : Service() {
    ...
    fun subscribeToLocationUpdates() {
        Timber.i("subscribeToLocationUpdates()")
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        return notificationCompatBuilder
            ...
            .addAction(
                R.drawable.ic_refresh, "Launch activity.",
    ...
    companion object {
        ...
        private const val NOTIFICATION_CHANNEL_ID = "campus_booking_channel_01"
    }
}
